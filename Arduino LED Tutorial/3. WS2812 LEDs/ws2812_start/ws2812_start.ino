...
const int MAX_BRIGHTNESS = 64; // MAX VALUE 255
const int MIN_BRIGHTNESS = 2; // MIN VALUE 1
...
// Use Ctrl + / to commment/uncomment line
//  loopLED1();
//  loopLED2();
//  breathingLED();
//  rainbowEffect(3000);
...
// Variant 1: Turn ON and OFF all LEDs in clockwise
void loopLED1() {
  // Loop through all LEDs in sequence
  for (int i = 0; i < NUM_LEDS; i++) {
    leds[0] = 0xFF44DD; // Set LED color using Hex value
    FastLED.show();
    delay(100);
  }
  clearLEDs();
